 ...
 */
#define DEBUG_UART LPC_UART2		// We use SP - B (same side as JTAG connector) as Debug UART.
...
/* Board name */
#define BOARD_CLIMB_OBC_EM1

/**
 * LED defines
 */
#define LED_GREEN_WD       0x00		// LED1 							- Watchdog feed
#define LED_BLUE      	   0x01		// LED4 (SCH) 'LED1' (on EM1 print) - also RGB LED Data pin
#define LED_RGB      	   0x02		// LED4 (SCH) 'LED1' (on EM1 print) - also RGB LED Data pin
